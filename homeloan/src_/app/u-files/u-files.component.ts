...
@Component({
  selector: 'app-u-files',
  templateUrl: './u-files.component.html',
  styleUrls: ['./u-files.component.css'],
  providers: [SideNavComponent],
})
export class UFilesComponent {
  constructor(
  ...
  dataList: any = [
    {
      ...
      link: 'https://acramm.com/homeloan/admin/uploads/Loan_Application.docx',
    },
    {
      id: 1,
      name: 'Loan Proposal',
      link: 'https://acramm.com/homeloan/admin/uploads/Loan_Proposal.docx',
    },
  ];
