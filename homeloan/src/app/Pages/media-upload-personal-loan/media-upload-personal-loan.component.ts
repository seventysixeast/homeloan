...
@Component({
  selector: 'app-media-upload-personal-loan',
  templateUrl: './media-upload-personal-loan.component.html',
  styleUrls: ['./media-upload-personal-loan.component.css'],
  providers: [SideNavComponent],
})
export class MediaUploadPersonalLoanComponent {
  constructor(
  ...
  handleSubmit() {
    ...
    if(this.logedInUser.type == "Credit-Analyst"){
      ...
      this.ds.submitAppData(data).subscribe((response: any) => {
        ...
        this.router.navigateByUrl('personal-vehicle-loan/dashboard');
