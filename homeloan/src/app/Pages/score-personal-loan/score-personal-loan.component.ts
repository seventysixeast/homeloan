...
@Component({
  selector: 'app-score-personal-loan',
  templateUrl: './score-personal-loan.component.html',
  styleUrls: ['./score-personal-loan.component.css'],
  providers: [SideNavComponent],
})
export class ScorePersonalLoanComponent {
  constructor(
      ...
      this.ds.submitAppData(data2).subscribe((response2: any) => {
        ...
        this.ds.submitAppData(data3).subscribe((response3: any) => {
          if (response3 != null) {
            ...
            console.log('this.m_score',this.m_score)
  ...
  getSingleAppData() {
    ...
    this.ds.submitAppData(data).subscribe((response: any) => {
      if (response != null) {
        ...
        if(checkView === 'true' && this.logedInUser.type != "Credit-Approver"){
          this.viewOnly =  true;
          ...
          }else if(this.logedInUser.type == "Credit-Approver" && this.m_score == 0){
